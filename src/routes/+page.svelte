...
<div class="bg-linear-to-b from-cream to-white">
	<main>
		<!-- hero -->
		<div
			class="reveal-section my-8 flex min-h-screen w-full flex-col items-center justify-center gap-8 px-4 py-12 md:-my-16 md:flex-row md:py-0"
		>
			<div
		...
		<div class="mx-4 my-12 flex flex-col gap-12 sm:m-10 md:m-20 md:gap-16">
			...
			<div class="reveal-section ml-0 flex flex-col gap-6 md:ml-12 lg:flex-row lg:gap-14">
				...
				<div class="flex flex-col text-left lg:mr-20">
					<h1
						class="text-[32px] leading-tight text-red sm:text-[40px] lg:text-[48px] lg:leading-12"
					>
			...
			<div class="reveal-section ml-0 flex flex-col gap-6 md:ml-12 lg:flex-row-reverse lg:gap-14">
				...
				>
					...
					<img
						src="/imgs/landing/freelance-2.png"
						alt="digital drawing of the golden gate bridge"
					/>
					<img src="/imgs/landing/freelance-3.jpg" alt="painting of a cat" />
				</div>
				<div class="flex flex-col text-left">
					<h1
						class="text-[32px] leading-tight text-blue sm:text-[40px] lg:text-[48px] lg:leading-12"
					>
			...
			<div class="reveal-section ml-0 flex flex-col gap-6 md:ml-12 lg:flex-row lg:gap-14">
				...
				<div class="flex flex-col text-left lg:mr-20">
					...
					<p
						class="text-[18px] leading-6 text-dark-blue sm:text-[20px] lg:text-[24px] lg:leading-7"
					>
		...
		>
			<h1 class="text-[32px] text-dark-blue sm:text-[40px] md:text-[48px]">
				send a message to kat
			</h1>
