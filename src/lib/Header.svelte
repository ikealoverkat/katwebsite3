...
<div
	class="sticky top-0 z-10 mt-4 flex flex-wrap items-center justify-between gap-2 bg-cream/75 px-8 py-4 text-[16px] backdrop-blur-md sm:text-[20px] md:text-[24px]"
>
